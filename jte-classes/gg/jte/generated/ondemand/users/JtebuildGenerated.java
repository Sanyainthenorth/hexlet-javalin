...
public final class JtebuildGenerated {
	...
	public static final int[] JTE_LINE_INFO = {0,0,1,3,3,3,5,5,8,8,10,11,11,12,12,12,12,13,13,13,16,16,23,23,23,23,23,23,23,23,23,29,29,29,29,29,29,29,29,29,30,30,30,30,31,31,32,32,32,33,33,41,41,41,41,41,41,41,41,41,42,42,42,42,43,43,44,44,44,45,45,53,53,53,53,54,54,55,55,55,56,56,68,68,68,68,68,68,68,68,68,79,79,79,79,79,3,3,3,3};
	public static void render(gg.jte.html.HtmlTemplateOutput jteOutput, gg.jte.html.HtmlInterceptor jteHtmlInterceptor, BuildUserPage page) {
		...
		gg.jte.generated.ondemand.layout.JtepageGenerated.render(jteOutput, jteHtmlInterceptor, new gg.jte.html.HtmlContent() {
			public void writeTo(gg.jte.html.HtmlTemplateOutput jteOutput) {
				...
				jteOutput.writeContent("\n\n            <div class=\"card shadow-sm\">\n                <div class=\"card-header bg-primary text-white\">\n                    <h1 class=\"card-title mb-0\">Создание пользователя</h1>\n                </div>\n                <div class=\"card-body\">\n                    <form");
